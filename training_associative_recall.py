...
plot(model, show_shapes=True, to_file="experiment/lstm_associative_recall.png")
print("Model summary")
print(model.summary())
...
for iteration in range(1, 200):
    ...
    check_pointer = ModelCheckpoint(
        filepath="experiment/associative_recall_model_weights.hdf5",
    ...
    for i in range(20):
        ...
        show_matrix.update(matrix_list_update,
                           name_list)
        show_matrix.save("experiment/associative_data_predict_%3d.png"%iteration)
